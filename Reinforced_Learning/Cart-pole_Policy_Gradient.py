...
def discount_rewards(r):
    ...
    for t in reversed(xrange(0, r.size)):
        # as it keeps running, discount the rewards based off of gamma
...
class agent():
    # learning rate, state_size, agent_size,
    def __init__(self, lr, s_size, a_size, h_size):
        ...
        self.indexes = (
                        tf.range(0, tf.shape(self.output)[0]) *
        ...
        self.updatebatch = optimizer.apply_gradients(zip(self.gradient_holders,
                                                         tvars))
        ...
        for j in range(max_ep):
            ...
            if d:
                ...
                if i % update_frequency == 0 and i != 0:
                    ...
                    _ = sess.run(myAgent.updatebatch, feed_dict=feed_dict)
                    for ix, grad in enumerate(gradBuffer):
                        gradBuffer[ix] = grad * 0
